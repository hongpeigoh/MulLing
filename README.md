...
`pip install annoy`
- [**Flask**](https://pypi.org/project/Flask/) for the app version of MulLing  
`pip install flask`
- [**Flask-Cors**](https://pypi.org/project/Flask-Cors/), the extension for cross-origin AJAX. Note: The latter exposes the app to devices in the network, which can have security risks! Use at your own discretion!  
